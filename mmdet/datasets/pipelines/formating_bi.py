...
@PIPELINES.register_module
class DefaultFormatBundleBi(object):
    ...
    - gt_bboxes_visible: (1)to tensor, (2)to DataContainer
    ...
    def __call__(self, results):
        ...
        for key in ['proposals', 'gt_bboxes', 'gt_bboxes_visible', 'gt_bboxes_ignore', 'gt_labels']:
