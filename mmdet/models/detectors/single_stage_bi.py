...
class SingleStageBiDetector(BaseDetector):
    ...
    def __init__(self,
        ...
        self.bbox_visible_head = builder.build_head(bbox_visible_head)
    ...
    def init_weights(self, pretrained=None):
        ...
        self.bbox_visible_head.init_weights()
    ...
    def forward_train(self,
        ...
        outs = self.bbox_head(x)
        outs_visible = self.bbox_visible_head(x)
        loss_inputs = outs + (gt_bboxes, gt_bboxes_visible, gt_labels, img_metas, self.train_cfg)
