...
def anchor_target_bi_visible(anchor_list,
                  valid_flag_list,
                  gt_bboxes_list,
    ...
    (all_labels, all_label_weights, all_bbox_targets, all_bbox_weights,
     pos_inds_list, neg_inds_list) = multi_apply(
         anchor_target_bi_visible_single,
         anchor_list,
         valid_flag_list,
         gt_bboxes_list,
         gt_bboxes_visible_list,
...
def anchor_target_bi_visible_single(flat_anchors,
                         valid_flags,
                         gt_bboxes,
                         gt_bboxes_visible,
                         gt_bboxes_ignore,
    ...
    if sampling:
        ...
        bbox_assigner = build_assigner(cfg.assigner_bi_visible)
