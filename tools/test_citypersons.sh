...
# CUDA_VISIBLE_DEVICES=0 python tools/test.py ${CONFIG_FILE} ${CHECKPOINT_FILE} --out result/citypersons_retinanet_free_anchor_r50_fpn_1x_epoch30.pkl --eval ${EVAL_METRICS}
# 
